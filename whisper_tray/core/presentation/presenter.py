...
from whisper_tray.core.presentation.errors import describe_error
from whisper_tray.core.presentation.formatting import format_transcript
...
class AppStatePresenter:
    """Map internal app state to tray and overlay presentation."""
